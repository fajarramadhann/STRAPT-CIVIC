...
// import { config } from '@/providers/XellarProvider'; // Backup - kept for reference
...
import { useCivicWallet } from './use-civic-wallet';
// import { useXellarWallet } from './use-xellar-wallet'; // Backup - kept for reference
...
export function useOptimizedStraptDrop() {
  ...
  const { address, isConnected } = useCivicWallet();
  ...
  }, [address, isConnected, getDropInfo, updateTransactionState]);
